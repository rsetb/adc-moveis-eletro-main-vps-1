...
const CarnetContent = ({ order, settings, pixPayload, productCodeById }: { order: Order; settings: StoreSettings, pixPayload: string | null, productCodeById: Map<string, string> }) => {
    ...
    return (
        <div className="carnet-content-wrapper bg-white text-black break-inside-avoid-page print:p-0 text-sm print:text-[11px] print:leading-[1.25] flex flex-col relative">
            ...
            <div className="carnet-customer-grid grid grid-cols-1 sm:grid-cols-[1fr_180px] print-default:sm:grid-cols-[1fr_170px] gap-x-1 gap-y-0 py-0 print:py-0 border-b">
                ...
                <div className="flex items-start justify-end">
                    {pixPayload && (
                        <div className="w-full flex flex-col items-end gap-1">
                            <div className="carnet-qr w-full max-w-[150px] print-default:max-w-[140px] flex-shrink-0">
                                <PixQRCode payload={pixPayload} size={768} className="p-1" />
                            </div>
                            {settings.pixKey && (
                                <div className="w-full max-w-[180px] print-default:max-w-[170px]">
                                    ...
                                    <div className="flex items-center justify-center gap-2">
                                        ...
                                        <p className="carnet-pix-key font-mono whitespace-nowrap tracking-tighter text-center text-[14px] leading-tight print:text-[11px]">
                                            {settings.pixKey}
                                        </p>
                                    </div>
                                </div>
