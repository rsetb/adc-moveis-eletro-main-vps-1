...
const userEditFormSchema = z.object({
    ...
    role: z.enum(['admin', 'gerente', 'vendedor', 'vendedor_externo', 'vendedor_cobranca'], { required_error: 'O perfil é obrigatório.' }),
...
export default function ManageUsersPage() {
    ...
    const getRoleLabel = (role: UserRole) => {
        switch (role) {
            ...
            case 'vendedor_cobranca':
                return 'Vendedor Cobrança';
            default:
                return role;
        }
    };
                                        ...
                                        <FormItem>
                                            ...
                                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="vendedor_cobranca">Vendedor Cobrança</SelectItem>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-row items-center gap-3 rounded-md border p-3">
                                        ...
                                        <FormLabel className="cursor-pointer">Conta Ativa</FormLabel>
                                    </FormItem>
                                )}
                            />
                            <FormField
