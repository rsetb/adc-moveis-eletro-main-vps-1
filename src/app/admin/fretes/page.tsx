...
import { saveFreightAction, setFreightPaidAction, deleteFreightAction } from '@/app/actions/admin/freight';
...
export default async function FreightPage() {
  try {
    ...
    return <FreightPaymentsTable currentUserId={user.id} initialRows={rows} saveAction={saveFreightAction} paymentAction={setFreightPaidAction} deleteAction={deleteFreightAction} />;
  } catch (error) {
