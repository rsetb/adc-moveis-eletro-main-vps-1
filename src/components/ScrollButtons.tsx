...
export default function ScrollButtons() {
  ...
  useEffect(() => {
    const checkScrollPosition = () => {
      ...
      setShowScrollDown(nearTop && !nearBottom);
    };
    ...
    <div className="fixed bottom-24 right-6 z-50 flex flex-col gap-2 print-hidden">
        <Button
            ...
            className={cn(
                ...
                showScrollDown ? 'opacity-100 scale-100' : 'opacity-0 scale-0 pointer-events-none'
            )}
            aria-label="Descer para o final da página"
        >
